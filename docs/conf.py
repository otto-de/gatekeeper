...
project = u'Gatekeeper'
copyright = u'2015, OTTO (GmbH & Co. KG)'
author = u'Jens Schaa'
...
htmlhelp_basename = 'GatekeeperDoc'
...
# os.path.abspath('../core/metric.py')
# print("PATH:", os.path.abspath('../core/metric.py'))
sys.path.insert(0, os.path.abspath('.'))